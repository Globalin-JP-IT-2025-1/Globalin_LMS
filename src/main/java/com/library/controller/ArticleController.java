...
public class ArticleController {
    ...
    public String getArticle(@PathVariable("id") int id, Model model) {
    	...
    	model.addAttribute("pageTitle", "글 조회");
    	model.addAttribute("pagePath", "page/articleDetail.jsp");
    ...
    @PutMapping("/{id}")
    public String updateArticle(@PathVariable("id") int id, Article article, Model model) {
        boolean result = articleService.save(article);
