...
public class ArticleReplyCountAspect {
    ...
    public void increaseReplyCount(JoinPoint joinPoint) {
    ...
    public void decreaseReplyCount(JoinPoint joinPoint) {
    	Object[] args = joinPoint.getArgs();
    	int articlesId = (int) args[0];
    	
    	log.info("삭제 대상 댓글 id:" + articlesId + "- ArticleReplyCountAspect");
