...
<div class="container d-flex flex-column justify-content-center align-items-center regForm">
	...
	<div class="mb-3 col-6 d-flex gap-2">
        ...
        <div class="input-group d-flex align-items-center">
            <input type="text" id="usernameBox" class="form-control" value="" placeholder="아이디 입력" maxlength="20">
    ...
    <div class="mb-3 col-6 d-flex gap-2">
        ...
        <div class="input-group d-flex align-items-center">
            <input type="text" id="nameBox" class="form-control" placeholder="이름 입력" maxlength="30">
        </div>
    </div>
    ...
    <div class="mb-3 col-6 d-flex gap-2">
        ...
        <div class="input-group d-flex align-items-center">
            <input type="text" id="mobileBox1" class="form-control" value="010" maxlength="3">-
			<input type="text" id="mobileBox2" class="form-control" value="" maxlength="4">-
			<input type="text" id="mobileBox3" class="form-control" value="" maxlength="4">
        </div>
    </div>
    ...
    <div class="mb-3 col-6 d-flex gap-2">
        ...
        <div class="input-group d-flex align-items-center">
        	<input type="text" id="zipcodeBox" class="form-control" placeholder="우편번호 자동 입력">
        </div>
    </div>
    ...
    <div class="mb-3 col-6 d-flex justify-content-center align-items-center gap-2">
		...
		<button class="mb-3 btn btn-primary" onclick="insertMember()">회원가입</button>
    </div>
...
<div class="container d-flex flex-column justify-content-center align-items-center d-none"> <!-- 테스트시: d-none 해제 -->
	...
	<h3>서버 수신용</h3>
	<ul>
		<!-- <li>members_id : <input type="text" id="membersId"></li> -->
...
function testInsertMember() {
	...
	var password = document.getElementById("regForm-password").value;
	var name = document.getElementById("regForm-name").value;
...
function insertMember() {
    ...
    const member = {
        username: document.getElementById("regForm-username").value,
        password: document.getElementById("regForm-password").value,
            ...
            fetch(`/public/members`, {
                ...
                .then(response => {
                    if (response.ok) {
                        ...
                        Swal.fire("오류 발생", "회원가입 실패했습니다.", "error");
                    }
                })
                .catch(error => {
...
document.getElementById("usernameBox").addEventListener("blur", function () {
	document.getElementById("regForm-username").value = this.value;
});

document.getElementById("passwordBox").addEventListener("blur", function () {
	document.getElementById("regForm-password").value = this.value;
});

document.getElementById("nameBox").addEventListener("blur", function () {
    document.getElementById("regForm-name").value = this.value;
});

document.getElementById("zipcodeBox").addEventListener("blur", function () {
    document.getElementById("regForm-zipcode").value = this.value;
});
...
function combineMobile() {
    ...
    document.getElementById("regForm-mobile").value = originalValue1 + "-" + originalValue2 + "-" + originalValue3;
}
