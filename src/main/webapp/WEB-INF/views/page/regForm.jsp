...
<form action="/members" method="POST">
	<ul class="regForm">
		...
		</select> <a href="#">중복확인</a>
		</li>
		<li><input type="text" id="email" value="email"></li>
		<!-- 테스트 후 hidden으로 변경하기 -->
		<li>password : <input type="password" id="password"
			placeholder="비밀번호 입력" maxlength="20"></li>
		<li>password 확인 : <input type="password" id="confirmPassword"
			placeholder="비밀번호 입력" maxlength="20"><span id="pwMessage"></span></li>
		<li>name : <input type="text" value="name" maxlength="30"></li>
		<li>mobile : <input type="text" id="mobile1" value="010"
			maxlength="3">- <input type="text" id="mobile2" value="0000"
			maxlength="4">- <input type="text" id="mobile3" value="0000"
			maxlength="4">
		</li>
		...
		<li>zipcode : <input type="text" id="zipcode" value="자동 입력"
			maxlength="10"></li>
		<li>address : <input type="text" id="address" value="자동 입력"
			maxlength="100"><a href="#">주소찾기</a></li>
