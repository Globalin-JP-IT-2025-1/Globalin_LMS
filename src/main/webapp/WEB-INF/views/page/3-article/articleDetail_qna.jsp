...
<div class="container-fluid">
	<div class="mb-3 row">
		...
		<div class="btndiv">
			...
			<form action="/private/articles/qna/${article.articlesId}" method="post" id="articleForm" >
...
<div class="container-fluid mb-5 card articleDetail_div2">   
	...
	<div class="articleDetail_div3">
		<form action="/private/replies/${articlesId}/qna" method="post">
			<input type="text" name="${_csrf.parameterName}" value="${_csrf.token}" hidden="true"/>
			<c:choose>
				            ...
				            <c:if test="${replyList[i].authorId == userDetails.membersId or userDetails.membersId == 0}">
								...
								<div class="d-flex align-items-center" style="gap: 10px;">
									...
									<form id="statusForm-${replyList[i].repliesId}" method="post">
				                   	...
				                   	<!-- 댓글 삭제 버튼 (soft del) -->
					                <form action="/private/replies/${article.articlesId}/qna/${replyList[i].repliesId}/1" method="post">
					                    <input type="hidden" name="_method" value="PUT" />
					                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
...
<script>
    ...
    function cancleEdit(articlesId) {
       ...
       if (confirmCancel) {
            window.location.href = '/public/articles/qna/'+articlesId;
       }
    }
   ...
   function submitStatus(articlesId, replyId) {
      ...
      if (!articlesId || !replyId) {
        ...
        form.action = '/private/replies/'+articlesId+'/qna/'+replyId+'/'+status;
        form.submit();
   }
